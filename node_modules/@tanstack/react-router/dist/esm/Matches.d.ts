...
export type MakeRouteMatches<TRouter extends AnyRouter = AnyRouter, TRoute extends AnyRoute = ParseRoute<TRouter['routeTree']>> = TRoute extends any ? RouteMatch<TRoute['id'], TRoute['fullPath'], TRoute['types']['allParams'], TRoute['types']['fullSearchSchema'], TRoute['types']['loaderData'], TRoute['types']['allContext'], TRoute['types']['loaderDeps']> : never;
export declare function useMatches<TRouter extends AnyRouter = RegisteredRouter, TRouteMatch = MakeRouteMatches<TRouter>, T = Array<TRouteMatch>>(opts?: {
